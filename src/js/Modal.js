...
const btnBuy = document.querySelectorAll(".btn__modal")

btnBuy.forEach(item => item.addEventListener("click", Modal))
...
document.getElementById("send__modal").addEventListener("click",loading)
